...
class FilterFieldTableType(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_filterfield_id_table_type_id_direction",
            "filterfield_id",
            "table_type_id",
            "direction",
        ),
    ...
    filterfield_id: Mapped[int] = mapped_column(
        ...
        index=True,
        primary_key=True,
        doc="The filterfield associated with a table_type.",
    )
    table_type_id: Mapped[int] = mapped_column(
        ForeignKey("un0.table_type.id", ondelete="CASCADE"),
        index=True,
        primary_key=True,
        doc="The table_type associated with a filterfield.",
    )
...
class FilterValue(Base, BaseMixin, RBACMixin):
    ...
    match: Mapped[Match] = mapped_column(
        ENUM(Match, name="match", create_type=True, schema_name="un0"),
